...
3. `inst`下にインストールする^[http://www.hep.by/gnu/r-patched/r-exts/R-exts_41.html] 。Windowsの場合あらかじめ`gettext`のインストールが必要^[ https://www.stats.ox.ac.uk/pub/Rtools/goodies/gettext-tools.zip を`C:\Rtools\bin`以下に展開すればいい] 。
```sh
